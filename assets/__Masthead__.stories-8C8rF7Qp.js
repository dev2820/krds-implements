import{j as e}from"./jsx-runtime-CexXSJP5.js";import{T as i}from"./index-CDfRmw7X.js";import{a as w}from"./index-GJGSU1ij.js";import{c as g}from"./index-Bb4qSo10.js";import{r}from"./index-BP8_t0zE.js";import{c as b}from"./create-context-F0uuYADf.js";import{c as u}from"./cn-BeVKbU-K.js";import{C as j}from"./chevron-down-IPPJBYSD.js";import{E as _}from"./external-link-4l7QRTZP.js";import"./Display-BzLlPsAt.js";import"./Heading-CvIzU8k7.js";import"./Title-BYTkKWDv.js";import"./Body-azYe1GGa.js";import"./Detail-maxWErGh.js";import"./Label-DOncBlms.js";import"./createLucideIcon-CtRCGPks.js";const[k,p]=b({name:"Masthead",hookName:"useMastheadContext",providerName:"MastheadProvider",defaultValue:{open:!1,setOpen:()=>{}}}),m=r.forwardRef(({className:o,children:s,...t},n)=>{const[a,C]=r.useState(!1),l={open:a,setOpen:d=>{C(d)}};return e.jsx(k,{value:l,children:e.jsx("div",{role:"banner",className:u("bg-background-2 flex flex-col items-center",o),ref:n,...t,children:s})})}),D=r.forwardRef(({className:o,children:s,...t},n)=>{const a=p();return e.jsx("div",{className:u("min-h-8 max-w-desktop w-full",o),"data-orientation":"vertical","data-state":a.open?"open":"close","aria-expanded":a.open?"true":"false",ref:n,...t,children:s})}),h=r.forwardRef(({asChild:o,children:s,className:t,...n},a)=>{const C=p(),l=o?w:"button",d=()=>{C.setOpen(!C.open)};return e.jsxs(l,{className:u("[&[data-state=open]>svg]:rotate-180",t),ref:a,onClick:d,"data-state":C.open?"open":"close",...n,children:[s,e.jsx(j,{size:12,className:"transition-transform duration-200"})]})}),E=g(["overflow-hidden border-border-secondary transition-all duration-300 w-full flex flex-col items-center",'before:content-[""] before:w-full before:flex before:border-t-1 before:border-border-secondary'],{variants:{open:{true:"max-h-500px",false:"max-h-0"}},defaultVariants:{open:!1}}),A=r.forwardRef(({children:o,className:s,...t},n)=>{const a=p();return e.jsx("dl",{className:u(E({open:a.open}),s),"data-orientation":"vertical","data-state":a.open?"open":"close",ref:n,...t,children:o})}),y=r.forwardRef(({className:o,...s},t)=>e.jsx("dt",{className:u("mt-7 mb-5 max-w-desktop w-full",o),ref:t,...s})),N=r.forwardRef(({children:o,className:s,...t},n)=>e.jsx("dd",{className:u("mb-7 pl-28px max-w-desktop w-full",s),ref:n,...t,children:o}));m.__docgenInfo={description:"",methods:[],displayName:"Root"};D.__docgenInfo={description:"",methods:[],displayName:"Container"};h.__docgenInfo={description:"",methods:[],displayName:"Dropdown"};A.__docgenInfo={description:"",methods:[],displayName:"Description"};y.__docgenInfo={description:"",methods:[],displayName:"DescriptionTitle"};N.__docgenInfo={description:"",methods:[],displayName:"DescriptionContent"};const G={title:"Components/Masthead",component:m,parameters:{layout:"centered",docs:{description:{component:`공식 배너는 사용자가 대한민국 정부 조직 및 관련 기관에서 운영 및 관리하는 디지털 정부서비스임을 식별할 수 있도록 제공하는 정보 배너이다.
